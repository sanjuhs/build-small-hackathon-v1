...
def modal_action_prompt(prompt_payload: dict[str, Any], payload: dict[str, Any]) -> str:
    ...
    allowed = {
        ...
        "interactionVerbs": ["none", "pickup", "carry", "bring", "walk", "run", "turn", "look_at", "point", "reach", "release", "inspect", "play", "talk", "sit", "read", "eat"],
    ...
    return "\n".join(
        [
            ...
            "- 'turn around' -> interaction.verb='turn', animation='turn'.",
            "- 'look at me' -> interaction.verb='look_at', animation='look'.",
            "- 'point at/reach for/touch the yellow ball' -> interaction.verb='point' or 'reach' and use the exact object id.",
            "- 'drop it/put it down' -> interaction.verb='release'.",
